...
.confetti-piece {
  ...
  width: 10px;
  height: 20px;
  background-color: hsl(303, 100%, 89%);
  top: 0;
  opacity: 0;
  animation: makeItRain 5000ms infinite linear;
}
...
.confetti-piece:nth-child(odd) {
  background-color: hsl(47, 100%, 81%);
}
...
.confetti-piece:nth-child(3n-7) {
  background-color: hsl(346, 83%, 84%);
}
